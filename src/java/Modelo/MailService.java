...
public class MailService {
    ...
    private static final String USER = "sistemagae@gmail.com";     // Must be valid user in d.umn.edu domain, e.g. "smit0012"
    private static final String PASSWORD = "sgaeITTOL"; // Must be valid password for smit0012
    private static final String FROM = "sistemagae@gmail.com";     // Full info for user, e.g. "Fred Smith <smit0012@d.umn.edu>"
}